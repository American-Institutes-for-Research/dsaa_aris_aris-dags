...
download_edge_data >> Label("Running Sas Script") >> gen_nonfiscal >>  Label("QC Checks:Sas Output")  >> qc_sas_logs >>  gen_district_wide
gen_district_wide  >>  Label("QC Checks:Sas Output")  >> qc_sas_logs >> gen_nonfiscal_district 
gen_nonfiscal_district >>  Label("QC Checks:Sas Output")  >> qc_sas_logs >> qc_sas_output
